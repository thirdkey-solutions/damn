...
* Design a suite of simple dispute resolution smart contracts that can be easily and quickly incorporated into smart contracts
...
Note: Most of the expenses of this project will be incurred in USD. The budget is therefore priced in USD but will be converted in the funding proposal to ETH. Funds awarded to this proposal will be converted as needed to ETH, BTC or USD for payment of expenses.
...
CURRENTLY REVISING THIS SECTION.

The funding contract signatories will be Pamela Morgan and Andreas M. Antonopoulos. Funds will be converted to ETH, BTC and USD as necessary to execute on the deliverables.
